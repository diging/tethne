...
function updateGPlus() {
    ...
    /*
                ...
                http://www.google.com.ezproxy1.lib.asu.edu/webmasters/+1/button/
            */
    /*
    ...
    */
    ...
    if (suppressGPlus) {
		...
		if (gPlus.length) {
	        ...
	        $('body').append('<script type="text/javascript" src="https://apis-google-com.ezproxy1.lib.asu.edu/js/plusone.js"></script>');
		};
	}
}
