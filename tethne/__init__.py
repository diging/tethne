...
from tethne.networks.topics import *
...
from tethne.model.corpus.mallet import LDAModel, mallet_to_theta_featureset, mallet_to_phi_featureset
from tethne.model.corpus.gensim_lda import GensimLDAModel, gensim_to_theta_featureset, gensim_to_phi_featureset
