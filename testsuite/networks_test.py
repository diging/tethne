...
class TestCocitation(unittest.TestCase):
    ...
    def test_cocitations_two(self):
        ...
        expected_edges_list= [('LANG CL 2012 NAV RES LOG', 'RAO J 1992 RNEA TECHN B SER LAN'), ('LANG CL 2012 NAV RES LOG', 'ZOU CK 2011 TECHNOMETRICS'), ('LANG CL 2012 NAV RES LOG', 'FILIPPIDIS A 1992 FUEL'), ('RAO J 1992 RNEA TECHN B SER LAN', 'ZOU CK 2011 TECHNOMETRICS'), ('RAO J 1992 RNEA TECHN B SER LAN', 'FILIPPIDIS A 1992 FUEL'), ('ZOU CK 2011 TECHNOMETRICS', 'FILIPPIDIS A 1992 FUEL')]
        self.assertListEqual(obtained_edges_list, expected_edges_list, "Edges List is not as expected")
        
        #check if the nodes_list is same as expected
        
        expected_nodes_list=['LANG CL 2012 NAV RES LOG', 'RAO J 1992 RNEA TECHN B SER LAN', 'ZOU CK 2011 TECHNOMETRICS', 'FILIPPIDIS A 1992 FUEL']
