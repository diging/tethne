# TODO: write tests for collection, corpora, graph, matrix
...
class TestSifWriter(unittest.TestCase):
    ...
    def test_simple_graph(self):
        filepath = '{0}/testout/simple_graph'.format(datapath)
    ...
    def test_multi_graph(self):
        filepath = '{0}/testout/multi_graph'.format(datapath)
    ...
    def test_simple_attribs(self):
        filepath = '{0}/testout/simple_attribs'.format(datapath)
    ...
    def test_multi_attribs(self):
        filepath = '{0}/testout/multi_attribs'.format(datapath)
