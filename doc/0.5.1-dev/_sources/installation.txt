...
numerical Python libraries. You can download the latest version of Anaconda for free from `Continuum Analytics <https://store.continuum.io/cshop/anaconda/>`_.
